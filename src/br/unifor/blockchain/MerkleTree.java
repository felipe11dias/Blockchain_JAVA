...
public class MerkleTree {
    ...
    public static Node generateTree(ArrayList<String> dataBlocks) {
        ...
        for (String message : dataBlocks) {
            childNodes.add(new Node(null, null, calculateBlockHash(message)));
        }
    ...
    public static String calculateBlockHash(String message) {
        ...
        try {
            ...
            bytes = digest.digest(message.getBytes("UTF-8"));
    ...
    private static Node buildTree(ArrayList<Node> children) {
        ...
        while (children.size() != 1) {
            ...
            while (index < length) {
                ...
                String parentHash = calculateBlockHash(leftChild.getHash() + rightChild.getHash());
